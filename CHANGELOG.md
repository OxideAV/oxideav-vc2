...
## [0.0.2](https://github.com/OxideAV/oxideav-vc2/compare/v0.0.1...v0.0.2) - 2026-07-30

### Other

- Operating-Mode-A edit-unit completeness helpers in the mxf module
- 12.2 picture-number continuity + even-first-field rules in the conformance walker
- surface the live sequence header from the Decoder wrapper; RP 2042-3 posture note
- vc2 tests: hardening sweeps over the retained-metadata parse surface
- ST 2042-4 MXF mapping module - identifier ULs, Annex B CDCI mappings, sub-descriptor scanner
- ST 2042-2 generalized-level + Annex C profile conformance checking
- retain the full 11.4.6-11.4.10 source-parameter map + SourceOverrides record
- claim the registry-grounded container tags - Matroska V_DIRAC, MP4 drac / OTI 0xA4
- ground Table 10 signal-range presets against the staged verbatim transcription
